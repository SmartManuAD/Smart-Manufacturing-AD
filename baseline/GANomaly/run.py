...
from sklearn.base import BaseEstimator # añadido para que funcione con GridSearchCV o RandomizedSearchCV
from .base import BaseDetector

class GANomaly(BaseDetector): # añadido Base estimator
    ...
    # duplicado el predict_score para que la clase tenga el método decision_function
